...
do
  ...
  vim.keymap.set('t', '<Esc><C-h>', '<C-\\><C-n><C-h>', { desc = 'Exit terminal mode and move focus to the left window' })
...
do
  ...
  require('which-key').setup {
    ...
    spec = {
      { '<leader>f', group = '[S]earch', mode = { 'n', 'v' } },
...
do
  ...
  vim.keymap.set('n', '<leader>fc', builtin.commands, { desc = '[F]earch [C]ommands' })
  ...
  vim.keymap.set('n', '<leader>fn', function() builtin.find_files { cwd = vim.fn.stdpath 'config', follow = true } end, { desc = '[F]earch [N]eovim files' })
end
...
do
  ...
  vim.keymap.set({ 'n', 'v' }, '<leader>lf', function() require('conform').format { async = true } end, { desc = '[F]ormat buffer' })
end
