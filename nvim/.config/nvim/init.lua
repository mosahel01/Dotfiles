...
-- NOTE: Custom Keymaps : quality-of-life mappings
vim.keymap.set('n', ';', ':', { desc = 'CMD enter command mode' })
-- vim.keymap.set('i', 'jk', '<ESC>', { desc = 'Exit insert mode with jk' }) -- This is Nasty
...
require('lazy').setup({
  ...
  require 'kickstart.plugins.blink', -- adds auto-completions
