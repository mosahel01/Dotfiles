local c = require("colors.hqos.sunset_palette")
...
theme.set_highlights = function()
	...
	hl(0, "Directory", { fg = c.peach, bg = "NONE" })
	...
	hl(0, "String", { fg = c.peach, bg = "NONE" })
	hl(0, "Character", { fg = c.peach, bg = "NONE" })
	hl(0, "Number", { fg = c._orange, bg = "NONE" })
	hl(0, "Float", { fg = c._orange, bg = "NONE" })
	hl(0, "Boolean", { fg = c.coral, bg = "NONE" })
	hl(0, "Constant", { fg = c.coral, bg = "NONE" })
	hl(0, "Type", { fg = c.magenta, bg = "NONE" })
	hl(0, "Function", { fg = c._red, bg = "NONE" })
	hl(0, "Keyword", { fg = c.violet, bg = "NONE" })
	hl(0, "Conditional", { fg = c.coral, bg = "NONE" })
	...
	hl(0, "StorageClass", { fg = c.magenta, bg = "NONE" })
	hl(0, "Structure", { fg = c.magenta, bg = "NONE" })
	...
	hl(0, "SpecialChar", { fg = c.peach, bg = "NONE" })
	...
	hl(0, "yamlTSField", { fg = c.violet, bg = "NONE" })
	hl(0, "luaFunc", { fg = c.orange, bg = "NONE" })
	hl(0, "luaFunction", { fg = c.violet, bg = "NONE" })
	...
	hl(0, "htmlTag", { fg = c.violet, bg = "NONE" })
	hl(0, "htmlTagN", { fg = c.violet, bg = "NONE" })
	hl(0, "htmlTagName", { fg = c.violet, bg = "NONE" })
	hl(0, "htmlComment", { fg = c.peach, bg = "NONE" })
	...
	hl(0, "cssImportant", { fg = c.violet, bg = "NONE" })
	hl(0, "jsonKeyword", { fg = c.violet, bg = "NONE" })
	hl(0, "yamlBlockMappingKey", { fg = c.violet, bg = "NONE" })
	hl(0, "tomlTSProperty", { fg = c.violet, bg = "NONE" })
	...
	hl(0, "markdownLinkText", { fg = c.violet, bg = "NONE" })
